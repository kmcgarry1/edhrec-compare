    ...
    it('should fetch multiple pages with delay', async () => {
        ...
        (global.fetch as any)
            .mockResolvedValueOnce({
                ok: true,
                json: async () => ({
                    data: [{ id: '1', name: 'Card 1', cmc: 1, type_line: 'Instant', colors: [], set: 'lea', rarity: 'common', prices: {} }],
                    has_more: true,
            ...
            .mockResolvedValueOnce({
                ok: true,
                json: async () => ({
                    data: [{ id: '2', name: 'Card 2', cmc: 1, type_line: 'Instant', colors: [], set: 'lea', rarity: 'common', prices: {} }],
                    has_more: false,
                }),
            });
