...
<template>
  ...
  <div class="md:hidden">
    <button @click="toggleMenu" class="p-3">☰</button>
    <div v-if="showMenu" class="fixed inset-0 bg-slate-900/90">
      <button class="w-full py-4 px-6 text-left">Upload CSV</button>
      <!-- ... -->
    </div>
  </div>
...
- #70 - Visual hierarchy (button prominence)
- #71 - Information density (overall spacing)
- docs/issues/medium-priority/11-form-input-accessibility.md (touch targets)
